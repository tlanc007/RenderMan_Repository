/* I mangled this in an effort to get it to scale and map properly on the 
 * sphere I was using. Changes are in the shader space code.
 * It produces prodigious continental drift when animated!
 * -- indy AT is DOT com  */

/*I took wave's lead and renamed terran to KMTerran.sl -- tal AT renderman DOT org */
	...
	float mottle_mag = .02;)
{
 ...
 /* Do all shading in object space */
  Ptexture = transform ("object", P);
