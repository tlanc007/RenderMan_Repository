/* I took wave's lead and renamed starfield to KMstrata.sl -- tal AT renderman DOT org */
	...
	float octaves = 8;)
{
  ...
  Ct = color spline (mod (cmap, 1),
		     ...
		     color (177, 145, 87), color (177, 145, 87)
		     ) / 255;

  /* Shade like matte, but with color scaled by cloudcolor and opacity */
  Oi = 1;
  Ci = Cs * Ct * (Ka * ambient() + Kd * diffuse(faceforward(normalize(N),I)));
}
