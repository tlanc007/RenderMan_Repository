...
#@v1 = keys (%names);
$ssheet = qq|<head><LINK rel="stylesheet" type="text/css" href="/RMR/nav.css" title="navtitle"></head>\n|;
...
#	    print STDERR ">>>>$_";
	    ...
	    s!(RIB|RI|RC|SL|PRMan|BMRT)!<B>$1</B>!;
...
&Note1;
print "<P><I>\n";
print q|The RMR is <A HREF="/copyright.html">Copyright</A> &copy; 1995-2000 <A HREF="mailto:talrmr@pacbell.net">Tal L. Lancaster</A> all rights reserved</I></P></small>|;
