/* $Id: opt_7.c,v 1.1.1.1 2002/02/10 02:35:42 tal Exp $  (Pixar - RenderMan Division)  $Date: 2002/02/10 02:35:42 $ */
/*
 ...
 * Example 7:    Shadow Map With Bad Bias Values
 */
...
SpecialSetup(void)
{
    RtFloat NumSamples = 16.0, ResFactor = 2.0, Bias0 = 0.0, Bias1 = 0.0;
    ...
    RiLightSource("shadowlight", "nsamples", (RtPointer)&NumSamples,
            ...
            "from", (RtPointer)From, "to", (RtPointer)To, RI_NULL);
}
