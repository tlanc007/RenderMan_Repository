/* $Id: opt_13.c,v 1.1.1.1 2002/02/10 02:35:42 tal Exp $  (Pixar - RenderMan Division)  $Date: 2002/02/10 02:35:42 $ */
/*
 ...
 * Example 13:	Displacement Bound Nonexistant (or Too Small)
 */
void
SpecialSetup(void)
{
